tinymce.PluginManager.add("media", function (a, b) {
    ...
    function e() {
        ...
        n[m] = c, d = a.windowManager.open({
            title: "Insert/edit media and document file",
            data: k,
            bodyType: "tabpanel",
            body: [{
    ...
    var l = [
        ...
        //},
        {
        regex: /(.+)\.(pdf|doc|docx|xls|xlsx|ppt|pptx)$/,
        type: "iframe",
        w: '100%',
        h: '700px',
        url: "//docs.google.com/gview?url=$1.$2&embedded=true"
    }, {
        regex: /youtu\.be\/([\w\-.]+)/,
        type: "iframe",
        w: 425,
    ...
    a.on("ResolveName", function (a) {
        ...
        tooltip: "Insert/edit media and document file",
        icon: "newdocument",
        ...
        icon: "newdocument",
        text: "Insert/edit media and document file",
        onclick: e,
        context: "insert",
        prependToContext: !0
    })
