...
class CleaningSchedulesItems extends Models
{
    ...
    {
        return $this->belongsTo('\Model\CleaningSchedulesTasks', 'task_id');
    }

    public function submitted()
    {
        return $this->hasMany('\Model\CleaningSchedulesSubmitted', 'task_item_id');
    }

    public function repository()
    {
        return \App::make('\Repositories\CleaningSchedulesItems', [$this]);
    }
    ...
    public function getLastSubmitted()
    {
        ...
        if($submitted -> count())
            if($id = $this->getMaxId($submitted))
                if($record = \Model\CleaningSchedulesSubmitted::find($id))
                    return $record;
        return null;
    }
