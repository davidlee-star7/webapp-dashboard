<li class="col-md-2 col-xs-6 col-sm-6 pointer">
        <?php $count = count($statsData['local-manager']['online']); $title = 'Online Users'; $color = $count?'navitas':'default'; $ico = 'fa-flag';  ?>
    ...
    @if($count)
            ...
            <section class="panel bg-white">
                ...
                <div class="list-group list-group-alt scrollable text-xs">
                    @foreach($statsData['local-manager']['online'] as $row)
                ...
                <div class="panel-footer text-sm">
                    <a href="\online-users">See all the {{$title}}</a>
                </div>
            </section>
        </section>
    @endif
