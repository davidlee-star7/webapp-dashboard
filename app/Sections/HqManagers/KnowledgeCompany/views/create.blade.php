                        ...
                        <div id="general" class="collapse">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 {{{ $errors -> has('content_one') ? 'has-error' : '' }}}">
                                    <textarea wyswig="basic-upload" name="content_one"  class="form-control" placeholder="{{Lang::get('common/general.specific.content_one')}}">{{Input::old('content_one', null)}}</textarea>
