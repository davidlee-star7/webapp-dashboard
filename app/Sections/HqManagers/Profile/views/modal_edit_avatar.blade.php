...
<div class="panel-default">
    <div class="col-sm-12 users-avatar center">
        ...
        <div class="avatar"><img src="{{$currentUser->avatar()}}"></div>
    </div>
    <div class="col-sm-12 center">
        <div class="avatar-data center" data-avatar='{{URL::to('/profile/edit/avatar')}}' data-width="320" data-height="320" data-section="users" data-type="avatar">
