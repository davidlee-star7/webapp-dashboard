...
<div class="m-b-md">
    <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i>{{$sectionName}}
        <span class="pull-right">
           <a class="btn btn-green inline" href="{{URL::to('/haccp-company')}}"><i class="fa fa-search"></i> {{Lang::get('common/button.list')}} </a>
           <a class="btn btn-green inline" href="{{URL::to('/haccp-company/create')}}"><i class="fa fa-plus"></i> {{Lang::get('common/button.create')}} </a>
        </span>
    </h3>
</div>
