...
<!--logo tab-->
    <div id="logo" class="tab-pane fade active in">
        <div class="col-sm-12 supplier-avatar center">
            ...
            @if($headquarter->logo)
            <div class="logo"><img src="{{$headquarter->logo}}" width="100%"></div>
            @endif
        </div>
        <div class="col-sm-12 center">
            <div class="avatar-data center" data-avatar='{{URL::to('/headquarter/edit/logo')}}' data-width="400" data-height="240" data-section="supplier" data-type="logo">
