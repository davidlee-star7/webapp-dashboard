    ...
    <div class="col-sm-12">
        <section class="panel panel-default">
            ...
            <div class="table-responsive">
                <table class="table table-striped m-b-none dataTable small" id="dataTable" date-filter="true"  data-source="{{URL::to('/users/datatable')}}@if(\Input::get('role'))?role={{\Input::get('role')}}@endif">
                    <thead>
                        <tr>
                            <th></th>
