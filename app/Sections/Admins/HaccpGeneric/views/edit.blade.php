...
<div class="m-b-md">
    <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i>{{$sectionName}}
        <span class="pull-right">
           <a class="btn btn-green inline" href="{{URL::to('/haccp-generic')}}"><i class="fa fa-search"></i> {{Lang::get('common/button.list')}} </a>
           <a class="btn btn-green inline" href="{{URL::to('/haccp-generic/create')}}"><i class="fa fa-plus"></i> {{Lang::get('common/button.create')}} </a>
        </span>
    </h3>
</div>
                ...
                <form class="form-horizontal m-t" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 {{{ $errors -> has('title') ? 'has-error' : '' }}}">
                            <input name="title" type="text" class="form-control" placeholder="{{Lang::get('common/general.title')}}" value="{{Input::old('title', $haccp->title)}}">
                            @if($errors->has('title'))
                    ...
                    <div id="general" class="collapse">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('content') ? 'has-error' : '' }}}">
                                <textarea wyswig="basic-upload" name="content"  class="form-control" placeholder="{{Lang::get('common/general.content')}}">{{Input::old('content', $haccp->content)}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('content') ? 'has-error' : '' }}}">
                                <textarea wyswig="basic-upload" name="hazards"  class="form-control" placeholder="{{Lang::get('common/general.hazards')}}">{{Input::old('hazards', $haccp->hazards)}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('control') ? 'has-error' : '' }}}">
                                <textarea wyswig="basic-upload" name="control"  class="form-control" placeholder="{{Lang::get('common/general.control')}}">{{Input::old('control', $haccp->control)}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('monitoring') ? 'has-error' : '' }}}">
                                <textarea wyswig="basic-upload" name="monitoring"  class="form-control" placeholder="{{Lang::get('common/general.monitoring')}}">{{Input::old('monitoring', $haccp->monitoring)}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('corrective_action') ? 'has-error' : '' }}}">
                                <textarea wyswig="basic-upload" name="corrective_action"  class="form-control" placeholder="{{Lang::get('common/general.corrective_action')}}">{{Input::old('corrective_action', $haccp->corrective_action)}}</textarea>
