...
@section('content')
    <div class="m-b-md">
        <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i>{{$sectionName}}
           ...
           <a class="btn btn-green inline" href="{{URL::to('/menu-visitor')}}"><i class="fa fa-search"></i> {{Lang::get('common/button.list')}} </a>
        </span>
        </h3>
    </div>
                    ...
                    <form class="form-horizontal m-t" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('menu_title') ? 'has-error' : '' }}}">
                                <input name="menu_title" type="text" class="form-control" placeholder="{{Lang::get('common/general.menu_title')}}" value="{{Input::old('menu_title',null)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('type') ? 'has-error' : '' }}}">
                                {{Form::select('type', array_merge(array('' => 'Please Select'),$types),  null, array('id'=>'type', 'class'=>'form-control m-b'))}}
                                @if($errors->has('type'))
                        ...
                        <div class="form-group type_options" id="opt_module">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('route_path') ? 'has-error' : '' }}}">
                                <input class="form-control" type="text" name="route_path" id="title" value="{{{ Input::old('route-path',  null) }}}" />
                        ...
                        <div class="form-group type_options" id="opt_link">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('link') ? 'has-error' : '' }}}">
                                <input class="form-control" type="text" name="link" id="module_link" value="{{{ Input::old('link', null) }}}" />
                                @if($errors->has('link'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('ico') ? 'has-error' : '' }}}">
                                <div class="col-sm-2 fa-5x text-navitas">
                                    <i id="icon-view" class="{{{ Input::old('ico',  null) }}}"></i>
                                    <input id="icon-input" type="hidden" name="ico"  value="{{{ Input::old('ico',  null) }}}" />
                                </div>
                                <div class="col-sm-3">
                                    <a  href="{{URL::to('/menu-visitor/icons')}}" data-toggle="ajaxModal" class="btn btn-primary"> Set Ico</a>
                                </div>
                                @if($errors->has('ico'))
