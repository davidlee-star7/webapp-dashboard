    ...
    <div class="col-sm-12">
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="form-googlemap">
                    <div class="row">
                        <div class="col-sm-6">

                            <div class="form-group">
                                <div class="col-sm-12 {{{ $errors->has('headquarter') ? 'has-error' : '' }}}">
                                    <div class="h4 text-primary font-bold m-b">{{\Lang::get('/common/general.headquarter')}}:</div>
                                    {{Form::select('headquarter', $headquarters, null, ['class'=>'form-control'])}}
                                    @if($errors->has('headquarter'))
                                        <div class="text-danger">{{ Lang::get($errors->first('headquarter')) }}</div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 {{{ $errors->has('mobile_phone') ? 'has-error' : '' }}}">
                                    ...
                                    <input type="text"
                                           ...
                                           maxlength="50"
                                           name="mobile_phone"
                                           value="{{Input::old('mobile_phone', null)}}" />
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div>
                                <input type="checkbox" id="welcome_message"> Send <span class="font-bold">WELCOME</span> email.
                            </div>
                            <div class=" textarea_message">
                                <textarea wyswig="basic" class="form-control"> </textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
