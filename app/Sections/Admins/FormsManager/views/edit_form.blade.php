...
<div class="m-b-md">
    <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i>{{$sectionName}}
        <span class="pull-right">
           <a class="btn btn-green" href="{{URL::to("/forms-manager/create")}}"><i class="fa fa-plus"></i> {{Lang::get('common/button.create')}} </a>
           <a class="btn btn-green" href="{{URL::to("/forms-manager")}}"><i class="fa fa-search"></i> {{Lang::get('common/general.list')}} </a>
        </span>
    </h3>
</div>
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <a href="{{URL::to('/forms-manager/form/'.$form->id.'/assigned')}}" data-toggle="ajaxModal" class="btn btn-sm btn-primary">
                                <i class="fa fa-edit "></i>
                                <span class="">Assigning</span>
                            </a>
                            <a data-toggle="ajaxModal" href="{{URL::to('/forms-manager/form/'.$form->id.'/display')}}" class="btn btn-rounded btn-sm btn-icon btn-success m-r inline tooltip-link pull-right" title="Display"><i class="fa fa-search"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-lg-9 col-md-8">
                        ...
                        <div class="dd nestable"  data-max_depth="2" >
                            <ol class="dd-list" id="items-list" data-url="{{URL::to('/forms-manager/sort-update')}}">
                                @include('Sections\Admins\FormsManager::partials.form-items.item', ['pageItems'=>$tree, 'first'=>true, 'types'=>$types,'refresh'=>0])
                            </ol>
                        </div>
                    </div>
                </div>
