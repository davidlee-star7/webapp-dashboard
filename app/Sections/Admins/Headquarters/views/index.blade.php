...
@section('content')
<div class="m-b-md">
    <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i>Clients
        <span class="pull-right">
           <a class="btn btn-green inline" href="{{URL::to('/headquarters/create')}}"><i class="fa fa-plus"></i> {{Lang::get('common/button.create')}} </a>
        </span>
    </h3>
</div>
    ...
    <div class="col-sm-12">
        <section class="panel panel-default">
            ...
            <div class="table-responsive">
                <table class="table table-striped m-b-none dataTable small" id="dataTable" date-filter="true"  data-source="{{URL::to('/headquarters/datatable')}}">
                    <thead>
                        <tr>
                            <th></th>
                            <th>{{Lang::get('common/general.created')}}</th>
                            <th>{{Lang::get('common/general.name')}}</th>
                            <th>{{Lang::get('common/general.units')}}</th>
                            <th>{{Lang::get('common/general.hq-mgr')}}</th>
