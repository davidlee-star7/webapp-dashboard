...
@section('content')
    <div class="m-b-md">
        <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i>{{$sectionName}}
           ...
           <a class="btn btn-green inline" href="{{URL::to('/menu-admin')}}"><i class="fa fa-search"></i> {{Lang::get('common/button.list')}} </a>
        </span>
        </h3>
    </div>
                    ...
                    <form class="form-horizontal m-t" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{{ $errors -> has('ico') ? 'has-error' : '' }}}">
                                ...
                                <div class="col-sm-3">
                                    <a  href="{{URL::to('/menu-admin/icons')}}" data-toggle="ajaxModal" class="btn btn-primary"> Set Ico</a>
                                </div>
                                @if($errors->has('ico'))
