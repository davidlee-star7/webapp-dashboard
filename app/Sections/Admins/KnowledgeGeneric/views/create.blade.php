                ...
                <div class="panel-body">
                    <form class="form-horizontal m-t" method="post">
                        ...
                        <div id="general" class="collapse">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{Lang::get('common/general.generic.content_one')}}</label>
                                <div class="col-sm-10 {{{ $errors -> has('content_one') ? 'has-error' : '' }}}">
                                    <textarea wyswig="basic" name="content_one"  class="form-control" placeholder="{{Lang::get('common/general.generic.content_one')}}">{{Input::old('content_one', null)}}</textarea>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{Lang::get('common/general.generic.content_two')}}</label>
                                <div class="col-sm-10 {{{ $errors -> has('content_two') ? 'has-error' : '' }}}">
                                    <textarea wyswig="basic" name="content_two"  class="form-control" placeholder="{{Lang::get('common/general.generic.content_two')}}">{{Input::old('content_one', null)}}</textarea>
