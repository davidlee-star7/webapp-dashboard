...
@section('title')
    @parent
    :: Resolve invalid temperatures for pods
@endsection
@section('content')
    <div id="page_content">
            ...
            <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-toolbar">
                    <h3 class="md-card-toolbar-heading-text large">
                        Area/Appliance: <span class="uk-text-bold navitas-text">{{$area->name}}</span>
                    </h3>
                </div>
                                ...
                                <div class="uk-dropdown-scrollable">
                                    @foreach($temperatures as $temperature)
                                        <tr>
                                            ...
                                            <td>{{\Carbon::createFromTimestamp($temperature->timestamp)->format('d-m-Y H:i')}}</td>
                                        </tr>
                                    @endforeach
                                </div>
                                </tbody>
