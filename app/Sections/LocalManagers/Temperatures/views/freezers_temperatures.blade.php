...
@section('content')
<div class="m-b-md">
    <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i> <span class="h3 text-primary">Freezers</span> Temperatures</h3>
</div>
<ul class="breadcrumb">
    <li><a href="/"><i class="fa fa-home"></i> Home</a></li>
    <li><a href="{{URL::to('/temperatures')}}"><i class="fa fa-list-ul"></i> Temperatures</a></li>
    <li><i class="fa fa-list-ul"></i> Freezers Areas</li>
</ul>
<div class="row">
    <div class="col-lg-12">
        <section class="panel panel-default outstanding-task-dashboard">
            <header class="panel-heading-navitas">
                Freezers Areas - Last Temperatures
            </header>
            <div class="row">
                <div class="col-sm-12">
