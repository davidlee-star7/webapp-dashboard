        ...
        <div id="page_content_inner">
            ...
            <h2 class="heading_b uk-margin-bottom">{{$sectionName}}
                <span class="panel-action">
                    <a class="md-btn md-bg-green-600 md-color-white md-btn-wave-light waves-effect waves-button waves-light" href="{{URL::to("/temperatures/forms")}}"><i class="material-icons">add</i> {{Lang::get('common/button.create')}} </a>
                </span>
            </h2>
            <div class="md-card">
                ...
                <div class="md-card-content">
                    <table class="uk-table uk-table-striped dataTable" id="dataTable" data-source="{{URL::to("/temperatures/forms/datatable")}}">
                        <thead>
                        <tr>
                            <th></th>
