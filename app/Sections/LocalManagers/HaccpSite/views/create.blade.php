					...
					<form method="post">
						...
						<div class="uk-grid" data-uk-grid-margin>
							<div class="uk-width-1-1">
								...
								<input name="title" type="text" class="md-input @if($errors->has('title')) md-input-danger @endif" required value="{{Input::old('title', null)}}">
								@if($errors->has('title'))
									<span class="uk-form-help-block uk-text-danger">{{ Lang::get($errors->first('title')) }}</span>
								@endif
							</div>
						</div>
						<div class="uk-grid" data-uk-grid-margin>
						...
						<div class="uk-grid uk-hidden" data-uk-grid-margin id="more_fields">
							<div class="uk-width-1-1">
								...
								<textarea wyswig="basic-upload" name="content">{{Input::old('content', null)}}</textarea>
							...
							<div class="uk-width-1-1">
								...
								<textarea wyswig="basic-upload" name="hazards">{{Input::old('hazards', null)}}</textarea>
							...
							<div class="uk-width-1-1">
								...
								<textarea wyswig="basic-upload" name="control">{{Input::old('control', null)}}</textarea>
							...
							<div class="uk-width-1-1">
								...
								<textarea wyswig="basic-upload" name="monitoring">{{Input::old('monitoring', null)}}</textarea>
							...
							<div class="uk-width-1-1">
								...
								<textarea  wyswig="basic-upload" name="corrective_action">{{Input::old('corrective_action', null)}}</textarea>
