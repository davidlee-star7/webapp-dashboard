...
@section('content')
    <div class="m-b-md">
        <h3 class="m-b-none"><i class="i i-arrow-down3 m-r"></i>{{$sectionName}}
           ...
           <a class="btn btn-green" href="{{URL::to("/check-list/submitted")}}"><i class="material-icons">list</i> {{Lang::get('common/general.submitted')}} </a>
        </span>
        </h3>
    </div>
        ...
        <div class="col-sm-12">
            <section class="panel panel-default">
                <table class="table table-striped m-b-none">
                    <thead>
                    <tr><th class="h3">Select check list task from list below:</th></tr>
                    </thead>
                    <tbody>
