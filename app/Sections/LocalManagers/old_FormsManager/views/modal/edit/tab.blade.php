        ...
        <div class="panel-body">
            <form role="form" data-action="{{URL::to('/forms-manager/edit/item/'.$item->id)}}">
                <div class="form-group">
                    ...
                    <input name="label" type="text" value="{{$item->label}}" placeholder="{{\Lang::get('/common/general.name')}}" class="form-control">
                </div>
                <div class="form-group">
                    <label>{{\Lang::get('/common/general.description')}}</label>
                    <textarea name="description" placeholder="{{\Lang::get('/common/general.description')}}" class="form-control">{{$item->description}}</textarea>
                </div>
