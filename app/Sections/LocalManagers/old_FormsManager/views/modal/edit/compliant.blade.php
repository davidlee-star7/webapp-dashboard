    ...
    <section class="panel panel-default">
        ...
        <div class="panel-body">
            <form role="form" data-action="{{URL::to('/forms-manager/edit/item/'.$item->id)}}">
                ...
                <?php $options = unserialize($item->options); ?>

                <div class="form-group">
                    <label>{{\Lang::get('/common/general.compliant_question')}}</label>
                    <input name="compliant_question" value="{{isset($options['compliant_question']) ? $options['compliant_question'] : 'Is form data compliant?'}}" type="text" placeholder="{{\Lang::get('/common/general.compliant_question')}}" class="form-control">
                </div>
