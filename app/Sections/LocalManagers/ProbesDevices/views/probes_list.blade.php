                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="">
                                ...
                                <a class="btn btn-rounded btn-sm btn-icon btn-default tooltip-link font-bold" data-toggle="ajaxModal" title="Edit" href="{{URL::to("/probes/devices/edit/$probe->id")}}">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                {{\HTML::mdOwnButton($probe->id,'probes/devices','delete','clear','btn-danger')}}
                            </div>
                        </td>
                    </tr>
