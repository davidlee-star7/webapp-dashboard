        ...
        <div id="page_content_inner">
            ...
            <h2 class="heading_b uk-margin-bottom clearfix">{{$sectionName}}
                <span class="panel-action">
                    <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="{{URL::to('/goods-in/create')}}"><i class="material-icons">add</i> {{Lang::get('common/button.create')}} </a>
                </span>
            </h2>
                ...
                <div class="md-card-content">
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-1-1">
                            ...
                            <table class="uk-table dataTable uk-table-valign-middle" id="dataTable" data-source="{{URL::to('/goods-in/datatable')}}">
                                <thead>
                                    <tr>
                                        <th></th>
