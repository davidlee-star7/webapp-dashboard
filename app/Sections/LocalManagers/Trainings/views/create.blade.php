        ...
        <div id="page_content_inner">
            ...
            <div class="md-card">
                ...
                <div class="md-card-content">
                    <form method="post" action="{{URL::to("/trainings/create")}}">
                        <input type="hidden" name="_token" value="<?= csrf_token() ?>" />
                        <div class="uk-grid">
                            <div class="uk-width-1-3 {{{ $errors->has('staff_id') ? 'has-error' : '' }}}">
                                <div class="md-input-wrapper md-input-filled">
                                    <label>{{Lang::get('common/sections.staff.title')}}</label>
                                    {{Form::select('staff_id', $staff, Input::old('staff_id', null), array('id'=>'staff', 'data-md-selectize'=>''))}}
                            ...
                            <div class="uk-width-1-3 {{{ $errors->has('address') ? 'has-error' : '' }}}">
                                ...
                                <input type="text" name="address" value="{{{ Input::old('address', null) }}}" class="md-input">
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-1-3 {{{ $errors->has('date_start') ? 'has-error' : '' }}}">
                                ...
                                <input type="text" name="date_start" value="{{{ Input::old('date_start', date('Y-m-d', strtotime('now'))) }}}" class="datetimepicker" style="width:100%">
                            ...
                            <div class="uk-width-1-3 {{{ $errors->has('date_finish') ? 'has-error' : '' }}}">
                                ...
                                <input type="text" name="date_finish" value="{{{ Input::old('date_finish', date('Y-m-d', strtotime('now'))) }}}" class="datetimepicker" style="width:100%">
                            ...
                            <div class="uk-width-1-3 {{{ $errors->has('date_refresh') ? 'has-error' : '' }}}">
                                ...
                                <input type="text" name="date_refresh" value="{{{ Input::old('date_refresh', date('Y-m-d', strtotime('now'))) }}}" class="datetimepicker" style="width:100%">
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-1-1">
                                ...
                                <textarea name="comments" class="md-input">{{{ Input::old('comments', null) }}}</textarea>
                            </div>
                        </div>
