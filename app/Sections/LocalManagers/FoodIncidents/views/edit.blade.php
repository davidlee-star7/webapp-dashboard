                        ...
                        <section>
                            ...
                            <div class="uk-grid">
                                ...
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <div class="uk-form-row parsley-row">
                                        ...
                                        <input name="s1_i1" value="{{$item->s1_i1}}" type="text" class="md-input" required />
                                    </div>

                                    <div class="uk-form-row parsley-row">
                                        <p>Date/time of purchase</p>
                                        <input name="s1_i2" value="{{$item->s1_i2}}" type="text" class="datetimepicker" required style="width:100%" />
                                    </div>
                                </div>
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <div class="uk-form-row parsley-row">
                                        <label>Name</label>
                                        <input name="s1_i3" value="{{$item->s1_i3}}" type="text" class="md-input" required />
                                    </div>
                                    <div class="uk-form-row parsley-row">
                                        <label>Address</label>
                                        <input name="s1_i4" value="{{$item->s1_i4}}" type="text" class="md-input" />

                                    </div>
                                    <div class="uk-form-row parsley-row">
                                        <label>Telephone</label>
                                        <input name="s1_i5" value="{{$item->s1_i5}}" type="text" class="md-input"  />

                                    </div>
                                    <div class="uk-form-row parsley-row">
                                        <label>Email address</label>
                                        <input name="s1_i6" value="{{$item->s1_i6}}" type="text" class="md-input"  data-type="email" />
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-1">
                                    ...
                                    <textarea name="s1_t1" type="text" class="md-input" rows="5" required>{{$item->s1_t1}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <div class="uk-form-row parsley-row">
                                        ...
                                        <input name="s2_i1" value="{{$item->s2_i1}}" type="text" class="md-input" required />
                                    </div>
                                    <div class="uk-form-row parsley-row">
                                        <p>Date coding</p>
                                        <input name="s2_i2" value="{{$item->s2_i2}}" type="text" class="datetimepicker" required style="width:100%" />
                                    </div>
                                    <div class="uk-form-row parsley-row">
                                        <p>Delivery date</p>
                                        <input name="s2_i3" value="{{$item->s2_i3}}" type="text" class="datetimepicker" required style="width:100%" />
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <div class="uk-form-row parsley-row">
                                        ...
                                        <select name="s2_s1">
                                            <option @if($item->s2_s1 == 'yes') selected="selected" @endif value="yes">Yes</option>
                                            <option @if($item->s2_s1 == 'no') selected="selected" @endif value="no">No</option>
                                        </select>
                                    </div>
                                    <div id="s2_s1" class="uk-form-row parsley-row">
                                        <div class="uk-form-row parsley-row">
                                            <label>Object colour</label>
                                            <input name="s2_i4"  value="{{$item->s2_i4}}" type="text" class="md-input" required />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <label>Object size</label>
                                            <input name="s2_i5" value="{{$item->s2_i5}}" type="text" class="md-input" required />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <label>Object weight</label>
                                            <input name="s2_i6" value="{{$item->s2_i6}}" type="text" class="md-input" required />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <label>Possible identity</label>
                                            <input name="s2_i7" value="{{$item->s2_i7}}" type="text" class="md-input" required />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <label>Where exactly found in food</label>
                                            <input name="s2_i8" value="{{$item->s2_i8}}" type="text" class="md-input" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="uk-width-1-1">
                                    <div class="uk-form-row parsley-row">
                                        ...
                                        <select class="md-input" name="s3_s0">
                                            <option @if($item->s3_s0 == 'yes') selected="selected"  @endif  value="yes">Yes</option>
                                            <option @if($item->s3_s0 == 'no') selected="selected"  @endif  value="no">No</option>
                                        </select>
                                    </div>
                                    <div id="s3_s0" class="uk-form-row parsley-row">
                                        <div class="uk-form-row parsley-row">
                                            <label>Food suspected to have caused illness</label>
                                            <input name="s3_i1" value="{{$item->s3_i1}}" type="text" class="md-input" required />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <label>Any other food purchased and eaten during the visit</label>
                                            <input name="s3_i2" value="{{$item->s3_i2}}" type="text" class="md-input" required />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <label>Symptoms of complaint</label>
                                            <input name="s3_i3" value="{{$item->s3_i3}}" type="text" class="md-input" required />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <p>Date symptoms began</p>
                                            <input name="s3_i4" value="{{$item->s3_i4}}" type="text" class="datetimepicker" required style="width:100%" />
                                        </div>
                                        <div class="uk-form-row parsley-row">
                                            <p>Date symptoms ceased</p>
                                            <input name="s3_i5" value="{{$item->s3_i5}}" type="text" class="datetimepicker" required style="width:100%" />
                                        </div>
                                        
                                        <div class="uk-form-row parsley-row">
                                            <select name="s3_s1" class="md-input">
                                                <option @if($item->s3_s1 == 'yes') selected="selected"  @endif  value="yes">Yes</option>
                                                <option @if($item->s3_s1 == 'no') selected="selected"  @endif  value="no">No</option>
                                            </select>
                                        </div>

                                        <div class="uk-form-row parsley-row">                                        
                                            <select name="s3_s2" class="md-input">
                                                <option @if($item->s3_s2 == 'yes') selected="selected"  @endif  value="yes">Yes</option>
                                                <option @if($item->s3_s2 == 'no') selected="selected"  @endif  value="no">No</option>
                                            </select>
                                        </div>

                                        <div class="uk-form-row parsley-row">
                                            <label>If a stool sample is available, please state:</label>
                                            <textarea name="s3_t1" class="md-input">{{$item->s3_t1}}</textarea>
                                        </div>
                                    </div>
