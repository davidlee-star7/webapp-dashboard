...
@section('title')
    {{$task->title}}<div class="uk-text-small xs uk-float-right">{{$dispDate}}</div>
    <div class="row padder">
        <div class="uk-text-small">{{$task->description}}</div>
    </div>
@endsection
@section('content')
@if($task->staff)
...
<hr>
<form id="createEventForm" class="form-horizontal" data-url="{{URL::to("/check-list/complete/$item->id")}}">
    <div class="padder">
