                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="uk-grid">
                            ...
                            <div class="uk-width-medium-5-6">
                                <a href="{{URL::to('/download/staff_data_scheme.xls')}}" class="font-bold">staff_data_scheme.xls</a>
                            </div>
                        </div>
                        ...
                        <div class="uk-grid">
                            ...
                            <div class="uk-width-medium-5-6">
                                <a href="{{URL::to('/download/staff_data_scheme.xlsx')}}" class="font-bold">staff_data_scheme.xlsx</a>
                            </div>
                        </div>
                        ...
                        <div class="uk-grid">
                            ...
                            <div class="uk-width-medium-5-6">
                                1) Don't edit rows with columns threads names (i.e.: first_name, surname...)<br>
                                2) Replace "example data" with your data from second row.<br>
                                3) In smartprobe cell, please enter: 1 as enabled or 0 as disabled.
                            </div>
                        </div>
