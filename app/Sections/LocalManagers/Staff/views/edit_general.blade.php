            ...
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <form method="post">
                        ...
                        <h3 class="heading_a">{{$actionName}} {{$staff->fullname()}}</h3>

                        <div class="uk-grid {{{ $errors->has('first_name') ? 'has-error' : '' }}}">
                            <div class="uk-width-1-1">

                                <label>{{Lang::get('common/form.first_name')}}</label>
                                <input type="text" name="first_name" value="{{{ Input::old('first_name', $staff->first_name) }}}" class="md-input" />
                        ...
                        <div class="uk-grid {{{ $errors->has('surname') ? 'has-error' : '' }}}">
                            <div class="uk-width-1-1">
                                ...
                                <input type="text" name="surname" value="{{{ Input::old('surname', $staff->surname) }}}" class="md-input" />
                        ...
                        <div class="uk-grid {{{ $errors->has('role') ? 'has-error' : '' }}}">
                            <div class="uk-width-1-1">
                                ...
                                <input type="text" name="role" value="{{{ Input::old('role', $staff->role) }}}" class="md-input" />
                                @if($errors->has('role'))
                        ...
                        <div class="uk-grid {{{ $errors->has('email') ? 'has-error' : '' }}}">
                            <div class="uk-width-1-1">
                                ...
                                <input type="text" name="email" value="{{{ Input::old('email', $staff->email) }}}" class="md-input" />
                                @if($errors->has('email'))
                        ...
                        <div class="uk-grid {{{ $errors->has('phone') ? 'has-error' : '' }}}">
                            <div class="uk-width-1-1">
                                ...
                                <input type="text" name="phone" value="{{{ Input::old('phone', $staff->phone) }}}" class="md-input" />
                                @if($errors->has('phone'))
                            ...
                            <div class="uk-width-5-6">
                                <div class="uk-grid">
                                    <div class="uk-width-1-4">
                                        <input name="smartprobe" type="radio" value="1" id="inlineCheckbox1" data-md-icheck @if(Input::old('smartprobe', $staff->smartprobe)) checked @endif>
                                        <label class="inline-label" for="inlineCheckbox1">
                                             {{Lang::get('common/general.yes')}}
                                        </label>
                                    </div>
                                    <div clsas="uk-width-1-4">
                                        <input name="smartprobe" type="radio" value="0" id="inlineCheckbox2" data-md-icheck @if(!Input::old('smartprobe', $staff->smartprobe)) checked @endif>
