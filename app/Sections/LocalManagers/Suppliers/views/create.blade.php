                        ...
                        <div class="uk-grid">
                            <div class="uk-width-medium-1-3 {{{ $errors->has('contact_person') ? 'has-error' : '' }}}">
                                ...
                                <input type="text"
                                       ...
                                       maxlength="50"
                                       name="contact_person"
                                       value="{{Input::old('contact_person', null)}}" />
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-medium-1-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{Input::old('contact_person1', null)}}"/>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <label>{{\Lang::get('/common/general.phone')}}</label>
                                <input type="text"
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-medium-1-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{Input::old('contact_person2', null)}}"/>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <label>{{\Lang::get('/common/general.phone')}}</label>
                                <input type="text"
