                    ...
                    <form method="post">
                        ...
                        <div class="uk-grid" data-uk-grid-margin>
                            <div class="uk-width-1-1">
                                ...
                                <input name="title" type="text" class="md-input" required value="{{Input::old('title', null)}}">
                                @if($errors->has('title'))
                        ...
                        <div class="uk-grid uk-hidden" data-uk-grid-margin id="more_fields">
                            ...
                            <div class="uk-width-1-1">
                                <label>{{Lang::get('common/general.individual.content_one')}}</label>
                                <textarea wyswig="basic-upload" name="content_one">{{Input::old('content_one', null)}}</textarea>
                            ...
                            <div class="uk-width-1-1">
                                <label>{{Lang::get('common/general.individual.content_two')}}</label>
                                <textarea wyswig="basic-upload" name="content_two">{{Input::old('content_two', null)}}</textarea>
