...
@section('content')
    <div id="page_content">
        <div id="page_content_inner">
            <h2 class="heading_b uk-margin-bottom">Knowledge forms
                <span class="panel-action">
                    <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="{{URL::to("/knowledge/forms/submitted")}}">
                        <i class="material-icons">search</i> {{Lang::get('common/general.submitted')}}
                    </a>
                </span>
            </h2>
