@section('title')
    Cleaning schedule completing ::
    @parent
@endsection
@section('content')
    <div id="page_content">
        <div id="page_content_inner">
            <h2 class="heading_b uk-margin-bottom"><i class="i i-arrow-down3 m-r"></i>Cleaning schedules
                <span class="panel-action">
					<a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="{{URL::to("/cleaning-schedule")}}"><i class="material-icons">keyboard_arrow_left</i>Back to calendar</a>
				</span>
            </h2>
            <div class="md-card">
            ...
            <div class="md-card">
                ...
                <div class="md-card-content">
                    <form id="completeSimpleTask" data-url="{{URL::to("/cleaning-schedule/complete/$item->id")}}">
                        <div class="uk-grid">
                            <div class="uk-width-1-1">
                            ...
                            <div class="uk-width-1-1">
                                <?php
                                $targetType = 'cleaning_schedules_submitted';
